export const no = {
    ...
    profileDescription:
        "Software Engineer med master i informatikk og erfaring fra bank og finans. Jobber med AWS-infrastruktur, DevOps og backendutvikling, med bakgrunn fra fullstackutvikling og løsningsarkitektur.",
